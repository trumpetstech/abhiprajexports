    ...
    <div id="footer" class="footer-2 show-ribbon">
        <div class="footer-main">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <aside id="gtranslate-2" class="widget widget_gtranslate">
                            <h3 class="widget-title">Language Selector</h3>
                        ...
                        <div class="switcher notranslate">
                            <div class="selected">
                                <a href="#" onclick="return false;">
                                    <img src="wp-content/plugins/gtranslate/flags/16/en.png" height="16" width="16" alt="en" /> English
                                </a>
                            </div>
                            <div class="option">
                                <a href="#" onclick="doGTranslate('en|en');jQuery('div.switcher div.selected a').html(jQuery(this).html());return false;" title="English" class="nturl selected">
                                    <img data-gt-lazy-src="//abhiprajexports.com/wp-content/plugins/gtranslate/flags/16/en.png" height="16" width="16" alt="en" /> English
                                </a>
                                <a href="#" onclick="doGTranslate('en|fr');jQuery('div.switcher div.selected a').html(jQuery(this).html());return false;" title="French" class="nturl">
                                    <img data-gt-lazy-src="//abhiprajexports.com/wp-content/plugins/gtranslate/flags/16/fr.png" height="16" width="16" alt="fr" /> French
                                </a>
                                <a href="#" onclick="doGTranslate('en|de');jQuery('div.switcher div.selected a').html(jQuery(this).html());return false;" title="German" class="nturl">
                                    <img data-gt-lazy-src="//abhiprajexports.com/wp-content/plugins/gtranslate/flags/16/de.png" height="16" width="16" alt="de" /> German
                                </a>
                                <a href="#" onclick="doGTranslate('en|hi');jQuery('div.switcher div.selected a').html(jQuery(this).html());return false;" title="Hindi" class="nturl">
                                    <img data-gt-lazy-src="//abhiprajexports.com/wp-content/plugins/gtranslate/flags/16/hi.png" height="16" width="16" alt="hi" /> Hindi
                                </a>
                                <a href="#" onclick="doGTranslate('en|mr');jQuery('div.switcher div.selected a').html(jQuery(this).html());return false;" title="Marathi" class="nturl">
                                    <img data-gt-lazy-src="//abhiprajexports.com/wp-content/plugins/gtranslate/flags/16/mr.png" height="16" width="16" alt="mr" /> Marathi
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="menu-footer-bottom-links-container">
                        <ul id="menu-footer-bottom-links" class="menu">
                            <li id="menu-item-725" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-725">
                                <a href="our-principles.php">Our Principles</a>
                            </li>
                    ...
                    <div class="contact-info">
                        <ul class="contact-details">
                            <li>
                                ...
                                <span>Niwas Regency, Canada Corner, Nashik,Maharashtra,India-422002</span>
                            </li>
                            <li>
                                <i class="fa fa-phone"></i>
                                <strong>Phone:</strong>
                                <span>(+91)98222-66007</span>
                            </li>
                            <li>
                                <i class="fa fa-envelope"></i>
                                <strong>Email:</strong>
                                <span>
                                    <a href="mailto:info@abhiprajexports.com">info@abhiprajexports.com</a>
                                </span>
                            </li>
                            <li>
            ...
            <div class="col-md-2">
                <aside id="follow-us-widget-2" class="widget follow-us">
                    ...
                    <div class="share-links">
                        <a href="https://www.facebook.com/pg/Abhipraj-Exports-1737983859586522"  rel="nofollow" target="_blank" data-toggle="tooltip" data-placement="bottom" title="Facebook" class="share-facebook">Facebook</a>
                        <a href="#"  rel="nofollow" target="_blank" data-toggle="tooltip" data-placement="bottom" title="Twitter" class="share-twitter">Twitter</a>
                        <a href="https://www.instagram.com/abhiprajexports/"  rel="nofollow" target="_blank" data-toggle="tooltip" data-placement="bottom" title="Instagram" class="share-instagram">Instagram</a>
                        <a href="#"  rel="nofollow" target="_blank" data-toggle="tooltip" data-placement="bottom" title="Google +" class="share-googleplus">Google +</a>
                    </div>
                </aside>
            </div>
        </div>
...
<div class="footer-bottom">
    <div class="container">
        <div class="footer-left">
            <span class="logo">
                <a href="index.php" title="Abhipraj Exports - Abhipraj Exports | Fruit Farming | Grapes Farming">
                    <img class="img-responsive" src="wp-content/uploads/2017/12/abhiraj68x47.png" alt="Abhipraj Exports" />
                </a>
            </span>
            © Copyright 2018. ABHIPRAJ EXPORTS,All Rights Reserved. Developed by
            <a target="_blank" href="https://trumpets.co.in/">Trumpets</a>
        </div>
    </div>
</div>
</div>
...
<script type='text/javascript'>
    /* <![CDATA[ */
    var js_porto_vars = {"rtl":"","ajax_url":"https:\/\/abhiprajexports.com\/wp-admin\/admin-ajax.php","change_logo":"1","container_width":"1170","grid_gutter_width":"30","show_sticky_header":"1","show_sticky_header_tablet":"1","show_sticky_header_mobile":"1","ajax_loader_url":":\/\/abhiprajexports.com\/wp-content\/themes\/porto\/images\/ajax-loader@2x.gif","category_ajax":"","prdctfltr_ajax":"","show_minicart":"1","slider_loop":"1","slider_autoplay":"1","slider_autoheight":"1","slider_speed":"5000","slider_nav":"","slider_nav_hover":"1","slider_margin":"","slider_dots":"1","slider_animatein":"","slider_animateout":"","product_thumbs_count":"4","product_zoom":"1","product_zoom_mobile":"1","product_image_popup":"1","zoom_type":"inner","zoom_scroll":"1","zoom_lens_size":"200","zoom_lens_shape":"square","zoom_contain_lens":"1","zoom_lens_border":"1","zoom_border_color":"#888888","zoom_border":"0","screen_lg":"1200","mfp_counter":"%curr% of %total%","mfp_img_error":"<a href=\"%url%\">The image<\/a> could not be loaded.","mfp_ajax_error":"<a href=\"%url%\">The content<\/a> could not be loaded.","popup_close":"Close","popup_prev":"Previous","popup_next":"Next","request_error":"The requested content cannot be loaded.<br\/>Please try again later."};
    /* ]]> */
</script>
<script type='text/javascript' src='wp-content/themes/porto/js/theme.min5fc8.js?ver=4.0.4'></script>
